 ...
 */
SESTransport.prototype.handleMessage = function (mail, raw, configurationSetName, callback) {
    var params = {
        RawMessage: { // required
            Data: new Buffer(raw, 'utf-8') // required
        }
    };
    if (mail.message.configurationSetName) {
        params.ConfigurationSetName = mail.message.configurationSetName;
    }
